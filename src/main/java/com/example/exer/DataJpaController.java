...
import com.example.exer.exceptions.NonexistentEntityException;
...
public class DataJpaController implements Serializable {
    ...
    private EntityManagerFactory emf = Persistence.createEntityManagerFactory("com.example_exer_jar_0.0.1-SNAPSHOTPU");
